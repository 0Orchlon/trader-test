...
- **Тооцоолсон notional** (сүүлийн quote-оор, `stale` бол ил тэмдэгтэй).
  Эх сурвалж нь `GET /market/quote/{symbol}` — operator-ийн бичсэн limit үнэ
  БИШ, ингэснээр market/stop order дээр ч дүн харагдана, Risk-ийн R9-тэй нэг
  лавлах үнэ болно. Quote байхгүй бол дүн ЗОХИОХГҮЙ, «quote байхгүй» гэж бичнэ.
