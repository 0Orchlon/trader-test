...
`approve` нь `expected_version`-оор optimistic lock хийдэг тул reaper-тэй
уралдах нөхцөлд 409 буцна — TTL дууссан мөрийг зөвшөөрөх боломжгүй.
...
| **Унтраах бэлтгэл** | шар, төв | «Компьютераа удахгүй унтраах гэж байна уу? Агентууд позиц хаах боломжтой, шинэ эрсдэл нэмэхгүй. Grace дуусахад систем бүрэн зогсоно.» |
| **Идэвхжүүл** | ногоон, баруун | «Арилжааг дахин эхлүүлэх үү? Систем `HALTED`-аас `ACTIVE` болно.» + breaker-ийн одоогийн метрикүүд |

Асуулт бүр ӨӨР үг, өөр өнгө, өөр байрлал. Backend талд `confirmation.prompt`
нь энэ текстийг өгнө (§8.4) — UI-д хатуу кодлохгүй, ингэснээр хоёр эх
үүсэхгүй.
...
- §11.1-ийн холимог тохиолдолд symbol нь `холимог origin` тэмдэгтэй, бүх
  холбогдох origin-ийн картад харагдана — далдлахгүй.
...
| Market data WS тасарсан | Frontend «stale» banner 5s дотор; tick-ээс шийдвэр гаргахгүй | §16.7 |
